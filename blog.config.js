...
const BLOG = {
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'klz BLOG', // 站点标题
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由klz生成的站点', // 站点描述
  AUTHOR: 'klzxuanye', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://xuanye.cf', // 网站地址
  ...
  CONTACT_EMAIL: 'klzxuanye@outlook.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/klzxuanye/',
  CONTACT_TELEGRAM: '',
